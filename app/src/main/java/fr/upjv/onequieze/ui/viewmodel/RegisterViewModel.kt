...
class RegisterViewModel(private val authRepository: AuthRepository) : ViewModel() {
    ...
    fun register(email: String, password: String, username: String, profileImageStream: InputStream?) {
        viewModelScope.launch {
            authRepository.register(email, password, username, profileImageStream).addOnCompleteListener { task ->
